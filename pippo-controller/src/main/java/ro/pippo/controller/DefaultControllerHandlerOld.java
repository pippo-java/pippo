 ...
 * @author Decebal Suiu
 */
public class DefaultControllerHandlerOld implements ControllerHandler {
    ...
    public DefaultControllerHandlerOld(Class<? extends Controller> controllerClass, String methodName) {
    ...
    public void handle(Context context) {
        ...
        try {
            ControllerApplication application = (ControllerApplication) context.getApplication();
