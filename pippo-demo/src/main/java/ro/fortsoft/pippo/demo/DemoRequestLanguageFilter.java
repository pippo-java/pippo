...
import ro.fortsoft.pippo.core.route.RequestLanguageFilter;
 ...
 *
 */
public class DemoRequestLanguageFilter extends RequestLanguageFilter {

	public DemoRequestLanguageFilter(Languages languages, boolean enableQueryParameter) {
